...
//身体検査データ用クラスの配列から平均身長と視力の分布を求める（グラフ表示）
public class PhysicalExaminationOfSight {
	private static final int VMAX = 21; // 視力の分布（0.0から0.1刻みで21個）
	...
	//--- 視力の分布を求める ---//
	private static void distVision(PhyscData[] dat,
			int[] dist) {
		int i = 0;
